...
namespace JsonLD.Core
{
    ...
    public interface IJSONLDTripleCallback
    {
        ...
        /// GRAPH: Is the graph name/IRI.
        ///
        /// If no graph is present for a triple, it will be listed under the "@default" graph
        ///
        /// TRIPLE:
        /// Is a map with the following structure: { "subject" : SUBJECT, "predicate" : PREDICATE, "object" : OBJECT }
        ...
        /// - "object" can be and IRI, blank node id, a literal value (represented as a string), a "type" : "IRI" if the value is an IRI or "blank node" if the value is a blank node.
